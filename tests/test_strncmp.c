...
Test(test_strncmpm, not_equal_1, .init = init_func)
{
...
Test(test_strncmpm, equal, .init = init_func)
{
...
Test(test_strncmpm, not_equal_2, .init = init_func)
{
...
Test(test_strncmpm, not_equal_3, .init = init_func)
{
...
Test(test_strncmpm, not_equal_4, .init = init_func)
{
